...
* Run the script: `./install_java8.sh`
        ...
        sudo apt-get install ../oracle-java8-installer_8.491.1_amd64.deb \
                             ../oracle-java8-unlimited-jce-policy_8.491.1_all.deb \
                             ../oracle-java8-set-default_8.491.1_all.deb
